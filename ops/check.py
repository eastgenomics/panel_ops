...
def check_gene(gene: str, hgmd_dict: dict, nirvana_dict: dict):
    ...
    Args: gene (str): Gene symbol hgmd_dict (dict): Dict of HGMD data
...
def check_panelapp_dump_against_db(folder, session, meta, data_dicts: tuple):
    ...
    Args: folder (str): Folder in which panels are stored session (SQLAlchemy
        session): Session object meta (SQLAlchemy MetaData): Metadata object
